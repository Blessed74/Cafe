...
namespace Cafe {
    ...
    public partial class CafeDataSet3 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/CafeDataSet31.xsd";
        ...
        public partial class КатегорииDataTable : global::System.Data.TypedTableBase<КатегорииRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public КатегорииRow AddКатегорииRow(int id_категория, string Названия) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public КатегорииRow FindByid_категория(int id_категория) {
            ...
            private void InitClass() {
                ...
                this.columnНазвания.MaxLength = 50;
            }
        ...
        public partial class КатегорииRow : global::System.Data.DataRow {
            ...
            public int id_категория {
                get {
                    return ((int)(this[this.tableКатегории.id_категорияColumn]));
                }
                set {
                    this[this.tableКатегории.id_категорияColumn] = value;
                }
            }
            ...
            public string Названия {
                get {
                    try {
                        return ((string)(this[this.tableКатегории.НазванияColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Названия\' в таблице \'Категории\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableКатегории.НазванияColumn] = value;
                }
            }
            ...
            public bool IsНазванияNull() {
                return this.IsNull(this.tableКатегории.НазванияColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetНазванияNull() {
                this[this.tableКатегории.НазванияColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Cafe.CafeDataSet3TableAdapters {
    ...
    public partial class КатегорииTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Категории] WHERE (([id_категория] = @Original_id_категория) AN" +
                "D ((@IsNull_Названия = 1 AND [Названия] IS NULL) OR ([Названия] = @Original_Назв" +
                "ания)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Категории] ([id_категория], [Названия]) VALUES (@id_категория," +
                " @Названия);\r\nSELECT id_категория, Названия FROM Категории WHERE (id_категория =" +
                " @id_категория)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Категории] SET [id_категория] = @id_категория, [Названия] = @Названия WHERE (([id_категория] = @Original_id_категория) AND ((@IsNull_Названия = 1 AND [Названия] IS NULL) OR ([Названия] = @Original_Названия)));
SELECT id_категория, Названия FROM Категории WHERE (id_категория = @id_категория)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id_категория, Названия FROM dbo.Категории";
        ...
        public virtual int Fill(CafeDataSet3.КатегорииDataTable dataTable) {
        ...
        public virtual CafeDataSet3.КатегорииDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CafeDataSet3.КатегорииDataTable dataTable = new CafeDataSet3.КатегорииDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CafeDataSet3.КатегорииDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id_категория, string Original_Названия) {
        ...
        public virtual int Insert(int id_категория, string Названия) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(id_категория));
            if ((Названия == null)) {
                this.Adapter.InsertCommand.Parameters[1].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.InsertCommand.Parameters[1].Value = ((string)(Названия));
            }
        ...
        public virtual int Update(int id_категория, string Названия, int Original_id_категория, string Original_Названия) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(id_категория));
            if ((Названия == null)) {
                this.Adapter.UpdateCommand.Parameters[1].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.UpdateCommand.Parameters[1].Value = ((string)(Названия));
            }
            ...
            if ((Original_Названия == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(Original_Названия));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Названия, int Original_id_категория, string Original_Названия) {
            return this.Update(Original_id_категория, Названия, Original_id_категория, Original_Названия);
        }
    }
